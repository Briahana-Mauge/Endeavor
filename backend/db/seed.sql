...
VALUES
    ...
    ('DemoAdmin', 'User', 'demo@pursuit.org', TRUE, '');
...
-- 10
    ('DemoVolunteer', 'User', 'demo', 'demo@gmail.com', '', 'Pursuit', 'prsuit', 'Senior Software Engineer', TRUE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE, 'https://www.linkedin.com/in/','2019-09-01');
...
VALUES
    ...
    ('2019-11-13 15:00-04', '2019-11-13 15:45-04', 'Let''s Do Remote Lunch!',
    ...
    ('2019-07-01 13:00-04', '2019-07-01 13:45-04', 'Let''s Do Remote Lunch!',
        'Spend your WFH lunch break with 6 of our Fellows! Chat about anything! Get to know our Fellows and share your path to tech. We''ll share a list of possible topics as well. We''ll have 3 "Lunch Rooms" over Zoom each day so please choose more than 1 day in case dates get filled up. I''ll reach back out to confirm your date.',
        1, 'Pursuit HQ: 47-10 Austell Place, 2nd Fl Long Island City, NY 11101', 'Jessica Shyu', 20, FALSE),
    ...
    ('2020-04-02 17:30-04', '2020-04-02 19:30-04', 'Code Review on Hackathon Projects',
        ...
        15, 'Pursuit HQ: 47-10 Austell Place, 2nd Fl Long Island City, NY 11101', 'Alejandro Franco', 6, TRUE),
    -- -- -- 10
    ...
    ('2020-01-11 09:00-04', '2020-01-11 17:30-04', 'Conduct Virtual Technical Interviews',
        'Volunteers will conduct two 45-minute 1:1 technical interviews using a question bank and an interviewing guide, Afterwards, you''ll provide us with feedback through an evaluation form.Interviews will take place virtually over Google Hangouts and repl. We are looking for hiring managers or anyone who conducts interviews regularly.',
        15, 'Pursuit HQ: 47-10 Austell Place, 2nd Fl Long Island City, NY 11101', 'Dessa Shepherd', 10, TRUE),
    ...
    ('2020-06-13 10:00-04', '2020-06-13 15:00-04', 'Pursuit + Clorox DTC 6.2 FullStack Web Technical Showcase',
        ...
        10, 'https://zoom.us/my/alejos', 'Dessa Shepherd', 10, TRUE),

    ('2020-06-8 13:00-04', '2020-06-8 15:00-04', 'Google Remote Onsite',
        'Take some time getting to know some Google Engineers for an inside look at what it’s like to work at Google!',
        3, 'https://zoom.us/my/alejos', 'Alexis Medina', 10, FALSE),

    ('2019-06-23 10:00-04', '2019-06-30 18:00-04', '6.2 Welcome Week',
        'Let’s Welcome our new group of fellows to their first week at Pursuit.',
        14, 'Pursuit HQ: 47-10 Austell Place, 2nd Fl Long Island City, NY 11101', 'Jessica Shyu', 20, TRUE),

    ('2019-08-08 19:00-04', '2019-08-08 20:30-04', 'Industry Fluency: Career Pathways with Dion Ridley',
        'I''m excited to invite you to your first Industry Fluency event - a tech talk with Dion Ridley',
         1, 'Pursuit HQ: 47-10 Austell Place, 2nd Fl Long Island City, NY 11101', 'Jessica Shyu',20, FALSE),
 -- -- -- 20
    ('2019-10-24 17:45-04', '2019-10-24 20:00-04', 'Nomad Health Site Visit',
        'Excited to have you join us for the Nomad Health Site Visit!',
        1, '335 Madison Ave 5th Floor, New York, NY 10017', 'Alexis Medina', 5, FALSE),
