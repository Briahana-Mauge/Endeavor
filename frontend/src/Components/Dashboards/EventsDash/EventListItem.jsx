...
export default function EventPreviewCard(props) {
    ...
    const formatEventDate = date => {
        ...
        console.log("formatted: ", [d, `${t.slice(0, -6)} ${t.slice(-2)}`])
    ...
    return (
        // <tr onClick={handleClickOnEvent}>
        //     <td className="topicCol">
        //         <div id={'event' + event.event_id} className="g1EventListItem">
        //             {event.topic}
        //         </div>
        //     </td>
        ...
        <div className='col-12 col-sm-6 col-lg-4 col-xl-3 p-2'>
            <div className='border rounded-lg p-2'>
                <header className='text-center font-weight-bolder' >{event.topic}</header>
                {
