...
export default function FellowPreviewCard(props) {
    ...
    return (
        <div className='row mr-1 mb-1 border' style={{minWidth: '320px'}}>
            {
                fellow.want_mentor
            ...
            <div className='col-sm-6'>
                <img className='d-block rounded-circle imageIcon' src={fellow.f_picture} alt={`${fellow.f_first_name} ${fellow.f_last_name}`}/>
